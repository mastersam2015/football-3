...
<body >
<div id="tlo" style="position:absolute;z-index:-1;margin-top:0px;"><img src="tlo.jpg" id="obr" ></div>
...
$.get( "zapis.php", { cx: rx, cy: ry,lx: akx,ly: aky } ).done(function( data ) {
  ...
  // alert( data );
   ...
   if (data==0){
		...
		$.get( "ready.php", { p: 2 } ).done(function( data ) {
    //alert( "done" );
	});
